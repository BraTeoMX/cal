          ...
          <div class="card-body ">
            ...
            <div class="bmd-form-group{{ $errors->has('no_empleado') ? ' has-danger' : '' }}">
              <div class="input-group">
                  ...
                  <!-- Corregir el nombre del campo de 'number' a 'no_empleado' -->
                  <input type="number" name="no_empleado" class="form-control" placeholder="{{ __('# Empleado...') }}" value="{{ old('no_empleado') }}" required>
              </div>
