                    ...
                    <form method="POST" action="{{ route('formulariosCalidad.formControlCalidadEmpaque') }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="descripcion" class="col-sm-6 col-form-label">CAJAS AUDITADAS /
                                        CARTONS</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="cantidad_auditada" class="col-sm-6 col-form-label">No. DE BOLSAS X CAJA /
                                        BAGS IN CARTON</label>
                                    <div class="col-sm-12">
