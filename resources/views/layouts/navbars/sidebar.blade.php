            ...
            <li class="nav-item {{ $activePage == 'profile' || $activePage == 'user-management' ? ' active' : '' }}">
                ...
                <div class="collapse" id="laravelExamples">
                    <ul class="nav">
                        ...
                        <li class="nav-item{{ $activePage == 'Corte' ? ' active' : '' }}">
                        ...
                        <li class="nav-item{{ $activePage == 'control calidad empaque' ? ' active' : '' }}">
                            <a class="nav-link" href="{{ route('formulariosCalidad.controlCalidadEmpaque') }}">
                                <i class="material-icons">edit_document</i>
                                <p>{{ __('FCC-008') }}</p>
                                <p style="text-align: center;">{{ __('INTIMARK CONTROL DE CALIDAD EMPAQUE') }}</p>
                            </a>
                        </li>
                    </ul>
                </div>
